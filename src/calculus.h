...
extern typ grad_old[4 * how_many_planet + 4]; //The gradient of the Hamiltonian in the         old variables (lbd, -vrp; Lbd, D)
...
extern typ X_old   [4 * how_many_planet + 4]; //The old         variables (lbd, -vrp; Lbd, D). Indexes 4*i to 4*i+3 contain lbd_i to D_i
