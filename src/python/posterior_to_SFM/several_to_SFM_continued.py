...
plot_color    = ['gold', 'brown', 'purple', 'midnightblue', 'teal', 'lawngreen', 'gold', 'brown', 'purple', 'midnightblue', 'teal', 'lawngreen', 'gold', 'brown', 'purple', 'midnightblue', 'teal', 'lawngreen']
lbl           = ['Kepler-28 (2:3)', 'Kepler-57 (1:2)', 'Kepler-58 (2:3)', 'Kepler-49 (2:3)', 'Kepler-176 (1:2)', 'Kepler-128 (2:3)', '', '', '', '', '', '', '', '', '', '', '', '', '', '']
marker        = ['o', 'o', 'o', 'o', 'o', 'o', 's', 's', 's', 's', 's', 's', '^', '^', '^', '^', '^', '^']'''

N_pairs       = 3
pair_in_chain = [[0, 1], [0, 1], [0, 1]]
dummy_fst_col = [0, 0, 1] #Set to 1 if the first column of the posterior file is random
paths         = ['Kepler128_2', 'Kepler128_2', 'Kepler128bc']
rad           = [radHadden_df, radHadden_hm, radLeleu]
resonances    = [2, 2, 2] #Value of p such that the resonance is p : p + 1
plot_color    = ['blue', 'green', 'red']
lbl           = ['Kepler-128 (Hadden DFT)', 'Kepler-128 (Hadden H-M)', 'Kepler-128 (Leleu)']
marker        = ['o', 'o', 'o']
...
delta_min = -3.2#-3.3 #To be chosen by trial and error
delta_max = 50#17.4
X_min     = -13.6#-3.2
X_max     = 13.6#7.4
...
for pair in range(N_pairs):
      ...
      x2s = np.array(x2s)
      Ds  = np.array(Ds)
      ax1.scatter(Ds, x1s, c = plot_color[pair], marker = marker[pair],  s = 80, alpha = 0.4, label = lbl[pair])
      ax1.scatter(Ds, x2s, c = plot_color[pair], marker = marker[pair],  s = 80, alpha = 0.4)
