...
The file frequency.txt and frequency_fixed.csv contain the frequencies of the Hamiltonian starting from (X,0)
Rows are delta going from -20 to 50 with a step 0.002
Columns are X going from -14 to 14 with a step 0.01
