...
D3    = Lbd_3*(1-m.sqrt(1-e3**2))
sq2D_1= m.sqrt(2*D1/Lbd_10)
sq2D_2= m.sqrt(2*D2/Lbd_20)
sq2D_3= m.sqrt(2*D3/Lbd_30)
K_12  = G*m1*m2/a2
K_13  = G*m1*m3/a3
K_23  = G*m2*m3/a3
C_1   =  2.840432287941066
C_2   = -3.283257144153474
C_3   =  1.190493598136263
C_4   = -0.428369061168900
C_5   =  2.025222188195322
C_6   = -2.484004699367189
...
Phi_3 = (Lbd_1-D1)+(Lbd_2-D2)+(Lbd_3-D3)
