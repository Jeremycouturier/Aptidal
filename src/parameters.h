...
#define toInvar_bool 0       //Determines if the system is rotated so that the total angular momentum points in the z-direction. Irrelevant if _3D_bool is 0
...
#define body_Dt         {0.005684105110424833,0.0085276539078062524,0.0127948873567356096,0.019199985818302032,0.0288168206283456286}  //Tidal timelag of the bodies, in units of time.
