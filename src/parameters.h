...
#define body_sma          {1.,              1.6220063316856}                        //Initial and nominal semi-major axes of the planets. Used to computed the Hamiltonian's coef
#define body_ecc          {0.0003378148454, 0.0004783391484}                        //Initial eccentricities              of the planets.
#define body_lambda       {2.6780070194214, 2.54055800760030}                       //Initial mean longitudes             of the planets.
#define body_varpi        {2.2652799171149, 5.40695186030005}                       //Initial longitudes of the periapses of the planets.
