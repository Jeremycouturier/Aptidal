...
/*********************************************************************/
#define resonance_chain {3, 4, 6, 0}
...
#define body_masses {1.,   0.0000164,   0.0000232, 0.0000191, 0.000155}             //Masses of the bodies of the system, beginning with the star.
#define body_sma          {0.999964606, 1.215712517, 1.604557352, 2.216251602}      //Initial and nominal semi-major axes of the orbiting bodies. Used to computed the Hamiltonian's coef
#define body_ecc          {0.003925403, 0.003563875, 0.001476109, 0.002617027}      //Initial eccentricities              of the orbiting bodies.
#define body_lambda       {3.14159,     0.00,        0.00,        1.278903827}      //Initial mean longitudes             of the orbiting bodies.
#define body_varpi        {3.14159,     0.00,        3.14159,    -2.370273772}      //Initial longitude of the periapsis  of the orbiting bodies.
