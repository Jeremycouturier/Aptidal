...
#define body_sma        {1.,                1.34652168127,     1.84201574932}       //Initial and nominal semi-major axes of the planets. Used to computed the Hamiltonian's coef
#define body_ecc        {0.00025,           0.00050,           0.00017}             //Initial eccentricities              of the planets.
#define body_lambda     {1.57079632,        0.,                0.}                  //Initial mean longitudes             of the planets.
#define body_varpi      {3.1415926,         0.,                3.1415926}           //Initial longitudes of the periapses of the planets.
