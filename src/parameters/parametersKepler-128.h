...
/*********************************************************************/
#define pth "/home/atipique/Documents/Aptidal_simulation/towards_left/"
...
#define body_sma          {1.,              1.315961755}                            //Initial and nominal semi-major axes of the planets. Used to computed the Hamiltonian's coef
#define body_ecc          {0.00025,         0.00047}                                //Initial eccentricities              of the planets.
#define body_lambda       {1.88022,         2.0087}                                 //Initial mean longitudes             of the planets.
#define body_varpi        {2.71880,        -1.2602}                                 //Initial longitude of the periapsis  of the planets.
