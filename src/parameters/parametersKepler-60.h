...
/*********************************************************************/
#define pth "/home/atipique/Documents/Aptidal_simulation/towards_right/"
...
#define body_masses {1.,   0.0000140022422, 0.0000101652636, 0.0000117337061}       //Masses of the bodies of the system, beginning with the star.
#define body_sma          {1.,              1.1628646935072, 1.4137314338279}       //Initial and nominal semi-major axes of the planets. Used to computed the Hamiltonian's coef
#define body_ecc          {0.00025,         0.00047,         0.00039}               //Initial eccentricities              of the planets.
#define body_lambda       {1.88022,         2.0087,          0.00}                  //Initial mean longitudes             of the planets.
#define body_varpi        {2.71880,        -1.2602,         -2.9007}                //Initial longitude of the periapsis  of the planets.
