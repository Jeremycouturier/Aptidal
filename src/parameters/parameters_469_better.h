...
#define body_sma        {0.99996371265738,  1.34650728415789,  1.84205700325299}    //Initial and nominal semi-major axes of the planets. Used to computed the Hamiltonian's coef
#define body_ecc        {0.0000105174756051,0.0002972593666051,0.0001817210586157}  //Initial eccentricities              of the planets.
#define body_lambda     {3.34885452063507,  5.37419281255507,  3.58279520837004}    //Initial mean longitudes             of the planets.
#define body_varpi      {1.48306906964470, -0.46707492815186,  2.88339037172352}    //Initial longitudes of the periapses of the planets.
