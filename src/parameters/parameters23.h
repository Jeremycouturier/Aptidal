...
#define body_masses {1.,   0.0000164,0.0000232}                                     //Masses of the bodies of the system, beginning with the star.
#define body_sma          {1.,       1.310371}                                      //Initial semi-major axes            of the orbiting bodies.
#define body_ecc          {0.078,    0.15}                                          //Initial eccentricities             of the orbiting bodies.
#define body_lambda      {-1.2678,   0.27182}                                       //Initial mean longitudes            of the orbiting bodies.
#define body_varpi       {-1.0614,   0.81578}                                       //Initial longitude of the periapsis of the orbiting bodies.
...
#define resonance_chain   {2,        3}                                             //The resonance chain p_1:p_2:p_3: ... :p_n of the system.
