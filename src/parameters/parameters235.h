...
#define body_masses {1.,   0.0000208, 0.0000151,    0.0000192}                      //Masses of the bodies of the system, beginning with the star.
#define body_sma          {1.,        1.3103706971, 1.8420157493}                   //Initial and nominal semi-major axes of the orbiting bodies. Used to computed the Hamiltonian's coef
