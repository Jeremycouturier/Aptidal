...
#define body_sma          {0.997731966575, 1.217450819780, 1.579744663368}          //Initial and nominal semi-major axes of the orbiting bodies. Used to computed the Hamiltonian's coef
#define body_ecc          {0.000002147526, 0.001042245947, 0.001353598859}          //Initial eccentricities              of the orbiting bodies.
#define body_lambda       {2.288923353591, 0.27182,       -2.8035}                  //Initial mean longitudes             of the orbiting bodies.
#define body_varpi       {-2.719895370877,-5.812307988404,-2.671103336401}          //Initial longitude of the periapsis  of the orbiting bodies.
