...
#define body_masses {1.,   0.0000198, 0.0000136,    0.0000214,    0.0000128}        //Masses of the bodies of the system, beginning with the star.
#define body_sma          {1.,        1.2114137286, 1.5874010520, 1.9229994271}     //Initial and nominal semi-major axes of the orbiting bodies. Used to computed the Hamiltonian's coef
#define body_ecc          {0.02,      0.02,         0.02,         0.02}             //Initial eccentricities              of the orbiting bodies.
#define body_lambda      {-1.2678,    0.27182,     -2.8035,      -2.8035}           //Initial mean longitudes             of the orbiting bodies.
#define body_varpi       {-1.0614,    0.81578,     -3.07126,     -3.07126}          //Initial longitude of the periapsis  of the orbiting bodies.
