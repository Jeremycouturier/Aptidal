...
#define body_sma        {1.,               1.16084035919950, 1.40671871088901}      //Initial and nominal semi-major axes of the planets. Used to computed the Hamiltonian's coef
#define body_ecc        {0.013499025712203428, 0.030339683494069250, 0.010088416895255772}      //Initial eccentricities              of the planets.
#define body_lambda     {5.62613039776969, 0.78403931789809, 3.00767556394251}      //Initial mean longitudes             of the planets.
