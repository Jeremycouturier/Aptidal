...
#define body_sma        {1.000004456991713, 1.317710524299074, 1.7407583104386735, 2.3102117987653443, 3.0865771944685254}  //Initial and nominal semi-major axes of the planets.
#define body_ecc        {0.0004834870730296,0.00049117635460117,0.00030839053219745046,0.006405488954639363,1.6004960508244145e-6} //Initial eccentricities              of the planets.
#define body_lambda     {0.7751686256869148,3.2533512640111515,1.5302110617377698, 5.631820995206427,  1.0831604767994083}  //Initial mean longitudes             of the planets.
#define body_varpi      {0.2394931999756539,2.882371561867995,-1.8105969411716547,-1.5707513360222807,-0.8699367319193446}  //Initial longitudes of the periapses of the planets.
#if tides_bool
