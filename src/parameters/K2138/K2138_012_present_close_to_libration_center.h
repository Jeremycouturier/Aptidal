...
#define body_sma        {1.00008346718898,  1.31755186392578, 1.74082075774841}     //Initial and nominal semi-major axes of the planets. Used to computed the Hamiltonian's coef
#define body_ecc        {0.0009512043545649,0.0022216528606494,0.000920652033945681}//Initial eccentricities              of the planets.
#define body_lambda     {2.70493428457699,  2.21289918244336, 2.93097144308444}     //Initial mean longitudes             of the planets.
#define body_varpi      {1.15037526145609, -1.82838463427531,-4.91381679146683}     //Initial longitudes of the periapses of the planets.
#if tides_bool
