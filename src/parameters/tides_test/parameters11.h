...
#endif
#define body_masses {1.337103473310441e-5,1.4290562159203059e-5}  //Masses of the planets in units of the star mass.
...
#if tides_bool
#define body_radii  {0.0020838706470602,  0.002810401191461818}   //Radii of the planets, in units of length
#define body_k2     {1.5,                 1.5}                    //Second Love number of the planets
#define body_Dt     {0.009947183943243,   0.01768388256576614}    //Tidal timelag of the bodies, in units of time.
