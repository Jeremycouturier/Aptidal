...
#define body_sma        {1.,               1.16051594624160, 1.40732829159100}      //Initial and nominal semi-major axes of the planets. Used to computed the Hamiltonian's coef
#define body_ecc        {0.00244320578325, 0.03898879239133, 0.00192962929930}      //Initial eccentricities              of the planets.
#define body_lambda     {1.22847960195249,-1.45983490094329, 2.89556622661035}      //Initial mean longitudes             of the planets.
#define body_varpi     {-0.67780162956747,-2.86441121138188, 0.35647438423678}      //Initial longitudes of the periapses of the planets.
