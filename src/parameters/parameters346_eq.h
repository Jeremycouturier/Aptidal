...
#define body_sma          {0.999642288281, 1.212211963143, 1.591677586671}          //Initial and nominal semi-major axes of the orbiting bodies. Used to computed the Hamiltonian's coef
#define body_ecc          {0.012555493336, 0.011403261886, 0.004933655069}          //Initial eccentricities              of the orbiting bodies.
#define body_lambda       {3.141592653590, 0.00,           0.00}                    //Initial mean longitudes             of the orbiting bodies.
#define body_varpi        {3.141592653590, 0.00,           3.141592653590}          //Initial longitude of the periapsis  of the orbiting bodies.
