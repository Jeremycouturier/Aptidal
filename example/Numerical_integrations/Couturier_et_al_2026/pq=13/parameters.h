...
#define body_Dt      {.004880679879422183, .015285302670608172,  .012424718377309652} //Tidal timelag of the planets, in units of time. k21/Q1 = 4.6e-2, k22/Q2 = 7.2e-2, k23/Q3 = 3.9e-2
...
#else
#define body_Omega   {6.3484322370288811,  3.1630320082996362,   2.11018259003734889} //Initial sideral rotation of the planets, in radians/unit of time
#endif
#endif
