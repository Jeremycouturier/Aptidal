...
#endif
#define body_masses  {4.683972899082608e-5, 2.274512342940577e-5, 3.612177635072938e-5, 1.7506811495639516e-5} //Masses                              of the planets.
#define body_sma     {1.,                   1.5918118827991528,   2.522069200733769,    4.003524929619603}     //Initial and nominal semi-major axes of the planets.
#define body_ecc     {.13320319404728767,   .3635834477644079,    .12098941097786631,   .012092232774986052}   //Initial eccentricities              of the planets.
#define body_lambda {-.0826445970215748,   -.6926873302874776,   -1.6422435210018356,  -2.1424645749165965}    //Initial mean longitudes             of the planets.
#define body_varpi  {-.4538485653864797,   -2.4264906986364627,  -2.8036407338958287,  -.9592954855490847}     //Initial longitudes of the periapses of the planets.
...
#if tides_bool
#define body_radii   {.012883140853940654,  .006345227109059085,  .009985944159722709,  .004909021933991953}   //Radii of the planets, in units of length
#define body_k2      {.15,                  .15,                  .15,                  .15}                   //Second Love number of the planets
#define body_Dt      {9.55288284303231e-5,  2.125784404652773e-4, 7.673946108869375e-4, .0011899176665726671}  //Tidal timelag of the planets, in units of time. k21/Q1 = 0.9e-4, k22/Q2 = 1.0e-4, k23/Q3 = 1.8e-4, k24/Q4 = 1.4e-4
...
#else
#define body_Omega   {6.283332456804988,    3.128579489410265,    1.5687444922480507,   .7843679941500689}     //Initial sideral rotation of the planets, in radians/unit of time
#endif
#endif
