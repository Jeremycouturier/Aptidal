...
#define body_sma    { .021371774129215076,  .00080349596165564031,-.017197730579182401, .00067687802232757035,-.0045629353044866119,-.0042869731182544014,.0026834835670759361,.0025846532877332887} //vx
#define body_ecc    {-.0049330576204774648,-.01849859573609024,   -.0029096001975593782,.013807279315149952,   .0058747038358764481, .0035215868589132957,.002455246338012891, .0016616665006677774} //vy
...
#if _3D_bool
#define body_inc    {-.0048504663961073096,-.0083727681016184646, -.0012615424757345289,.0063148675696408215,  .0026292698053846592,.0016388979081295352, .0010373752191904901,.00061578094282450219}//vz
